...
require_once LAWYER_COMPANION_SW_DIR_PATH. 'instagram.php';
...
// Metabox include
require_once LAWYER_COMPANION_INC_DIR_PATH . 'lawyer-metabox.php';

// Elementor widgets include
require_once LAWYER_COMPANION_INC_DIR_PATH . 'functions.php';
require_once LAWYER_COMPANION_INC_DIR_PATH . 'instagram-api.php';
