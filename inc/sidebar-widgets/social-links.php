...
class Lawyer_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Lawyer ] Social Links', 'lawyer-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'lawyer-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'lawyer-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'lawyer-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'lawyer-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'lawyer-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'lawyer-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'lawyer-companion'); ?></label>
...
} // Class lawyer_social_links ends here


// Register and load the widget
function lawyer_social_links_widget_load() {
	register_widget( 'Lawyer_social_links' );
}
add_action( 'widgets_init', 'lawyer_social_links_widget_load' );