...
----------------------------------------*/
class lawyer_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('lawyer_instagram_photo',esc_html__('[ Lawyer ] Intagram Photo','lawyer-companion'),array(
			'description' => esc_html__('Lawyer Instagram Photo Widget','lawyer-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'lawyer-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'lawyer-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'lawyer-companion'); ?></label>
...
if(!function_exists('lawyer_instagram_widgets')):
	function lawyer_instagram_widgets(){
		register_widget('lawyer_instagram_photo');
	}
	add_action('widgets_init','lawyer_instagram_widgets');
endif;
