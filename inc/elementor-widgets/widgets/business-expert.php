...
/**
 *
 * Lawyer elementor business expert section widget.
 *
 * @since 1.0
 */
class Lawyer_Business_Expert extends Widget_Base {

	public function get_name() {
		return 'lawyer-business-expert';
	}

	public function get_title() {
		return __( 'Business Expert', 'lawyer-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Business Expert content', 'lawyer-companion' ),
			]
        );
		$this->add_control(
            'tab_content', [
                ...
                'fields' => [
                    [
                        'name' => 'tab_title',
                        'label' => __( 'Tab Title', 'lawyer-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Excellent Services', 'lawyer-companion' ),
                    ],
                    [
                        'name' => 'template_id',
                        'label' => __( 'Select Elementor Template', 'lawyer-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        'tab_title' => __( 'Excellent Services', 'lawyer-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Qualified Doctors', 'lawyer-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Emergency Departments', 'lawyer-companion' ),
                    ],
                ]
            ]
		);
    ...
    $this->start_controls_section(
        'style_room_section', [
            'label' => __( 'Style Business Expert Section', 'lawyer-companion' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    $this->add_control(
        'section_head_bg_col', [
            'label' => __( 'Section Head Bg Color', 'lawyer-companion' ),
    ...
    $this->add_control(
        'tab_content_styles_separator', [
            'label' => __( 'Tab Content Styles', 'lawyer-companion' ),
