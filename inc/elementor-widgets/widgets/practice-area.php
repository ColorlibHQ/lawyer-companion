...
/**
 *
 * Lawyer elementor parctice area widget.
 *
 * @since 1.0
 */
class Lawyer_Practice_Area extends Widget_Base {

	public function get_name() {
		return 'lawyer-practice-area';
	}

	public function get_title() {
		return __( 'Practice Area', 'lawyer-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Practice Area content', 'lawyer-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Practice Area', 'lawyer-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Practice Items', 'lawyer-companion' ),
		...
		$this->add_control(
            'practice_items', [
                ...
                'fields' => [
                    [
                        'name' => 'item_bg_img',
                        'label' => __( 'Item BG Image', 'lawyer-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_icon',
                        'label' => __( 'Item Icon', 'lawyer-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::ICON,
                        'default'     => 'flaticon-case',
                        'options'     => lawyer_themify_icon(),
                    ],
                    [
                        'name' => 'item_title',
                        ...
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Business Law', 'lawyer-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                    ...
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Anchor Text', 'lawyer-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                    ...
                    [
                        'name' => 'btn_url',
                        'label' => __( 'Anchor URL', 'lawyer-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [     
                        ...
                        'item_title' => __( 'Business Law', 'lawyer-companion' ),
                    ...
                    [     
                        ...
                        'item_title' => __( 'Finance Law', 'lawyer-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
                    ...
                    [     
                        ...
                        'item_title' => __( 'Family Law', 'lawyer-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
                    ...
                    [     
                        ...
                        'item_title' => __( 'Education Law', 'lawyer-companion' ),
                        'item_text'  => 'There are many variations of passages of <br> Lorem Ipsum available, <br> but the majority have suffered',
                        'btn_text'     => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'     => [
                            'url'      => '#'
            ...
            <div class="row no-gutters">
                ...
                if( is_array( $practice_items ) && count( $practice_items ) > 0 ) {
                    foreach( $practice_items as $item ) {
                        ...
                        $item_bg_img  = !empty( $item['item_bg_img']['id'] ) ? wp_get_attachment_image( $item['item_bg_img']['id'], 'lawyer_practice_thumb_448x500', '', array('alt' => $item_title . ' image' ) ) : '';
