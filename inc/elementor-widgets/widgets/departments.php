...
/**
 *
 * Lawyer elementor departments section widget.
 *
 * @since 1.0
 */
class Lawyer_Departments extends Widget_Base {

	public function get_name() {
		return 'lawyer-departments';
	}

	public function get_title() {
		return __( 'Departments', 'lawyer-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'lawyer-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'lawyer-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'lawyer-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'lawyer-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'lawyer-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'lawyer-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem.', 'lawyer-companion' ),
                    ],
                    [
                        'name' => 'btn_text',
                        ...
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Learn More', 'lawyer-companion' ),
                    ],
                    [
                        'name' => 'btn_url',
                        'label' => __( 'Button URL', 'lawyer-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'lawyer-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'lawyer-companion' ),
                        'btn_text'   => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                        ],
                    ],
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'lawyer-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'lawyer-companion' ),
                        'btn_text'   => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'lawyer-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'lawyer-companion' ),
                        'btn_text'   => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'lawyer-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'lawyer-companion' ),
                        'btn_text'   => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'lawyer-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'lawyer-companion' ),
                        'btn_text'   => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'lawyer-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'lawyer-companion' ),
                        'btn_text'   => __( 'Learn More', 'lawyer-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'title_hover_col', [
                'label' => __( 'Title Hover Color', 'lawyer-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'lawyer_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
